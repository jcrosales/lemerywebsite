...
function mfna_bg_position( $body = false ){
	...
	if( $body ){
		...
		$array['no-repeat;center;fixed;cover']	= 'Parallax';
	}
...
function mfn_opts_setup(){
	...
	$menu = array(	
		...
		'general' => array(
			...
			'sections' 	=> array( 'general', 'sidebars', 'blog', 'portfolio', 'under-construction' ),
		),
		...
		'colors' => array(
			...
			'sections' 	=> array( 'colors-general', 'colors-header', 'content', 'colors-footer', 'colors-sliding-top', 'headings', 'colors-shortcodes' ),
		),
	...
	$sections['general'] = array(
		...
		'fields' => array(
			...
			array(
				...
				'desc' 		=> __('Font Icon, eg. <strong>icon-traffic-cone</strong>', 'mfn-opts'),
				'class' 	=> 'small-text',
	...
	$sections['layout-header'] = array(
		...
		'fields' => array(
			...
			array(
				'id' 		=> 'header-banner',
				'type' 		=> 'textarea',
				'title' 	=> __('Header Banner', 'mfn-opts'),
			...
			array(
				'id'		=> 'show-breadcrumbs',
				'type'		=> 'switch',
				'title'		=> __('Subheader Breadcrumbs', 'mfn-opts'),
				'options'	=> array('1' => 'On','0' => 'Off'),
				'std'		=> '1'
			),
