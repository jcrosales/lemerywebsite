		...
		'call_to_action' => array(
			...
			'fields' => array(
				...
				array(
					...
					'desc' 		=> __('Font Icon, eg. <strong>icon-lamp</strong>', 'mfn-opts'),
					'class'		=> 'small-text',
				),
		...
		'feature_list' => array(
			...
			'fields' => array(
				...
				array(
					...
					'type' 	=> 'textarea',
					'title' => __('Content', 'mfn-opts'),
					'desc' 	=> __('Please use <strong>[item icon="" title="" link=""]</strong> shortcodes here.', 'mfn-opts'),
		...
		'map' => array(
			...
			'fields' => array(
				...
				array(
					'id' 		=> 'title',
					'type' 		=> 'text',
					'title' 	=> __('Address Box Title', 'mfn-opts'),
					'class' 	=> 'small-text',
				),
				...
				array(
					'id' 		=> 'content',
					'type' 		=> 'textarea',
					'title' 	=> __('Address Box Content', 'mfn-opts'),
					'desc' 		=> __('HTML tags allowed.', 'mfn-opts'),
				),
...
function mfn_print_column( $item ) {
	if( ! key_exists('content', $item['fields']) ) $item['fields']['content'] = '';
	if( key_exists('animate', $item['fields']) && $item['fields']['animate'] ) echo '<div class="animate" data-anim-type="'. $item['fields']['animate'] .'">';
		echo do_shortcode( $item['fields']['content'] );
	if( key_exists('animate', $item['fields']) && $item['fields']['animate'] ) echo '</div>';
}
